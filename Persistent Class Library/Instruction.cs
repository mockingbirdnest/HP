...
namespace Mockingbird.HP.Class_Library
{
    ...
    public class Instruction
    {
        ...
        private bool ArgumentIsI
        {
            get
            {
                return arguments.Length == 1 &&
                       arguments [0] is Letter &&
                       ((Letter) arguments [0]).Value == 'I';
            }
        }
        ...
        private void SetText (Reader reader)
        {
            ...
            switch ((SymbolConstants) instruction.Id)
            {
                ...
                case SymbolConstants.SYMBOL_STO:
                    {
                        if (reader.Model == CalculatorModel.HP67 && ArgumentIsI)
                        {
                            text = reader.Unparse
                                (reader.ToSymbol (instruction.Name.Substring (0, 2) + "_I_67"));
