...
namespace Mockingbird.HP.Testing
{
    ...
    public class ToggleTest : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent ()
        {
            ...
            this.ToggleUnderTest.ToggleMoved += new Mockingbird.HP.Control_Library.Toggle.ToggleEvent (this.ToggleMoved);
            // 
            // ToggleTest
            // 
        ...
        private void ToggleMoved
            (object sender, Mockingbird.HP.Control_Library.TogglePosition position)
        {
            switch (position)
            {
                ...
                case Mockingbird.HP.Control_Library.TogglePosition.Center:
                    {
                        MessageBox.Show ("Now in the middle!");
                        break;
                    }
