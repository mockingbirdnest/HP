...
namespace HP67_Testing
{
	...
	public class CardTest : System.Windows.Forms.Form
	{
		...
		private HP67_Control_Library.Card CardUnderTest;
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.CardUnderTest = new HP67_Control_Library.Card();
			this.SuspendLayout();
			// 
			// PropertyGrid
			// 
			...
			this.PropertyGrid.SelectedObject = this.CardUnderTest;
			...
			this.Controls.Add(this.CardUnderTest);
