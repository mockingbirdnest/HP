...
namespace HP67Parser
{
	...
	public class Digit : Object, IAddress, IDigits, ILabel
	{
		private byte digit;
	...
	public class Indexed : Object, IAddress, IDigits
	{
		public Indexed () 
		{
		}
		...
		public void SetDigits (Memory m, Display d)
		{
			d.Digits = (byte) Math.Floor (Math.Abs (m.Recall (Memory.LetterRegister.I)));
		}
	}

	public class Letter : Object, IAddress, ILabel
	{
		private char letter;
	...
	public class Actions : IActions
	{
		...
		public void ReduceRULE_NULLARY_UNSHIFTED_INSTRUCTION_RCL_SIGMA_PLUS (Token token, Token [] tokens)
		{
			// <Nullary_Unshifted_Instruction> ::= Rcl 'Sigma_Plus'
			theEngine.Execute (tokens);
		}
		...
		public void ReduceRULE_NULLARY_UNSHIFTED_INSTRUCTION2 (Token token, Token [] tokens)
		{
		...
		public void ReduceRULE_RCL_SIGMA_PLUS_RCL_SIGMA_PLUS (Token token, Token [] tokens)
		{
		...
		public void ReduceRULE_DIGIT_COUNT (Token token, Token [] tokens)
		{
			// <Digit_Count> ::= <Digit>
		}

		public void ReduceRULE_DIGIT_COUNT_SUB_I (Token token, Token [] tokens)
		{
			// <Digit_Count> ::= 'Sub_I'
