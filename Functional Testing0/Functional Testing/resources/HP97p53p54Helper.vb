...
'Generated     : 2007/10/11 1:40:38 PM
...
Public MustInherit Class HP97p53p54Helper 
    ...
    '
    ' HP97PDFAdobeReader: with default state.
    '		.text : null
    ' 		.class : AcrobatSDIWindow
    ' 		.processName : AcroRd32.exe
    ' 		.name : null
    '
    Protected Function HP97PDFAdobeReaderWindow() As TopLevelSubitemTestObject
        HP97PDFAdobeReaderWindow = New TopLevelSubitemTestObject(GetMappedTestObject("HP97PDFAdobeReaderWindow"))
    End Function
    '
    ' HP97PDFAdobeReader: with specific test context and state.
    '		.text : null
    ' 		.class : AcrobatSDIWindow
    ' 		.processName : AcroRd32.exe
    ' 		.name : null
    '
    Protected Function HP97PDFAdobeReaderWindow(anchor As TestObject, flags As Long) As  TopLevelSubitemTestObject
        HP97PDFAdobeReaderWindow = New TopLevelSubitemTestObject(GetMappedTestObject("HP97PDFAdobeReaderWindow"), anchor, flags)
    End Function
